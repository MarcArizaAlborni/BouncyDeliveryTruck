...
bool ModuleSceneIntro::Start()
{
	...
	//Final Boost
	DetectorCube[10].SetPos(-30, 2, -5);
	DetectorCube[10].size = vec3{ 5, 1, 25 };
	//Principi Boost
	DetectorCube[11].SetPos(-70, 2, -5);
	DetectorCube[11].size = vec3{ 5, 1, 25 };
...
void ModuleSceneIntro::OnCollision(PhysBody3D* body1, PhysBody3D* body2)
{
	...
	if (body1 == Detector[11]) {
		BoostActive = true;
		LOG("BOOST ACTIVE");
	}

	if (body1 == Detector[10]) {
		BoostActive = false;
...
void ModuleSceneIntro::LoadLevelWalls()
{
	//LEVEL
...
void ModuleSceneIntro::DrawLevelWalls()
{
...
void ModuleSceneIntro::LoadStaticObstacles()
{
	//FILA CYLINDRES 1
	//CylBache5
...
void ModuleSceneIntro::DrawStaticObstacles()
{
	//FILA CYLINDRES 1
	//CylBache5
	Cylinder CylBache5(0.5, 5);
...
void ModuleSceneIntro::LoadDynamicObstacles()
{
	//OBJECTE 1
...
void ModuleSceneIntro::DrawDynamicObstacles()
{
	//FINISHLINE
...
void ModuleSceneIntro::LoadBridge()
{
...
void ModuleSceneIntro::DrawBridge()
{
	/*DetectorCube[11].SetPos(-70, 2, -5);
	DetectorCube[11].size = vec3{ 5, 1, 25 };
	...
	Cube BoostArea1(5, 0.5, 25);
	BoostArea1.SetPos(-70, 0, -5);
	BoostArea1.color = Red;
	BoostArea1.Render();
...
void ModuleSceneIntro::RewardsChoose()
{
	if (Have3 == true) {
		LOG("ALL 3 DELIVERED");
...
void ModuleSceneIntro::LoadRewards()
{
	Part1.size = { 1,1,1 };
	Part1.SetPos(0, -10, 0);
